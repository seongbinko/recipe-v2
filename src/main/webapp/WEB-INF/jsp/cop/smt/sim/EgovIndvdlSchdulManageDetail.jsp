...
<div id="wrap">
    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <form name="IndvdlSchdulManageForm" id="IndvdlSchdulManageFormh"
                ...
                <div class="modify_user">
                    <table>
                            ...
                            <td width="80%">
                                <c:forEach items="${schdulSe}" var="schdulSeInfo" varStatus="status">
                                    <c:if test="${schdulSeInfo.code eq resultList[0].schdulSe}">
                                        <c:out value="${fn:replace(schdulSeInfo.codeNm , crlf , '<br/>')}"
                                               escapeXml="false"/>
                                    </c:if>
                                </c:forEach>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="80%">
                                <c:out value="${fn:replace(resultList[0].schdulDeptName , crlf , '<br/>')}"
                                       escapeXml="false"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="80%">
                                <c:out value="${fn:replace(resultList[0].schdulNm , crlf , '<br/>')}"
                                       escapeXml="false"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <c:out value="${fn:replace(resultList[0].schdulCn , crlf , '<br/>')}"
                                       escapeXml="false"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="80%">
                                <c:out value="${fn:replace(resultList[0].schdulChargerName , crlf , '<br/>')}"
                                       escapeXml="false"/>
                            </td>
                        </tr>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#LINK"
                                   onclick="fn_egov_delete_IndvdlSchdulManage(); return false;"><spring:message
                            ...
                            <td>
                                <% if (null != session.getAttribute("LoginVO")) { %>
                                <a href="#LINK"
                                   onclick="fn_egov_modify_IndvdlSchdulManage(); return false;"><spring:message
