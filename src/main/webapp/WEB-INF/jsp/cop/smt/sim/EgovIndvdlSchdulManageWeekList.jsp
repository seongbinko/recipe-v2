    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <form name="deptSchdulManageVO" id="deptSchdulManageVO"
                  action="<c:url value='/'/>cop/smt/sim/EgovIndvdlSchdulManageWeekList.do" method="post">
                ...
                <DIV id="content2" style="width:712px;">
                        ...
                        <fieldset>
                            ...
                            <div class="sf_start">
                                <ul id="search_first_ul">
                                    <li>
                                        <select name="schdulSe" title="검새조건" class="select" id="schdulSe"
                                                onChange="fnEgovSchdulSe(this.form.schdulSe.options[this.form.schdulSe.selectedIndex].value);">
                                    ...
                                    <li>
                                        ...
                                        >
                                            <img alt="이전년도로 이동" src="<c:url value='/'/><%=sImgUrl %>btn_prev.gif"
                                        ...
                                        <a href="<c:url value='/'/>cop/smt/sim/EgovIndvdlSchdulManageWeekList.do?year=<%=iNowYear+1%>&amp;month=<%=iNowMonth%>&amp;week=<%=iNowWeek%>"
                                           onclick="fnSchduleSearch('<%=iNowYear+1%>','<%=iNowMonth%>','<%=iNowWeek%>'); return false;"
                                        >
                                            <img alt="다음년도로 이동" src="<c:url value='/'/><%=sImgUrl %>btn_next.gif"
                                        ...
                                        >
                                            <img alt="이전월로 이동" src="<c:url value='/'/><%=sImgUrl %>btn_prev.gif"
                                                 align="middle" style="margin-right:4px;border:0px;">
                                        </a>
                                        <%}%>
                                        <%=iNowMonth + 1%>월
                                        ...
                                        <a href="<c:url value='/'/>cop/smt/sim/EgovIndvdlSchdulManageWeekList.do?year=<%=iNowYear%>&amp;month=<%=iNowMonth+1%>&amp;week=<%=iNowWeek%>"
                                           onclick="fnSchduleSearch('<%=iNowYear%>','<%=iNowMonth+1%>','<%=iNowWeek%>'); return false;"
                                        >
                                            <img alt="다음월로 이동" src="<c:url value='/'/><%=sImgUrl %>btn_next.gif"
                                                 align="middle" style="margin-left:4px;border:0px;">
                                        </a>
                                        <%}%>&nbsp;&nbsp;&nbsp;
                                        <%if (iNowWeek > 0) { %>
                                        ...
                                        >
                                            <img alt="이전주로 이동" src="<c:url value='/'/><%=sImgUrl %>btn_prev.gif"
                                                 align="middle" style="margin-right:4px;border:0px;">
                                        </a>
                                        <%}%>
                                        <%=iNowWeek + 1%>주
                                        ...
                                        <a href="<c:url value='/'/>cop/smt/sim/EgovIndvdlSchdulManageWeekList.do?year=<%=iNowYear%>&amp;month=<%=iNowMonth%>&amp;week=<%=iNowWeek+1%>"
                                           onclick="fnSchduleSearch('<%=iNowYear%>','<%=iNowMonth%>','<%=iNowWeek+1%>'); return false;"
                                        >
                                            <img alt="다음주로 이동" src="<c:url value='/'/><%=sImgUrl %>btn_next.gif"
                                                 align="middle" style="margin-left:4px;border:0px;">
                                        </a>
                                        <%}%>
                                    </li>
                    ...
                    <div class="default_tablestyle">
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td nowrap="nowrap">
                                    <%=sTmpDate.substring(0, 4)%>년<%=sTmpDate.substring(4, 6)%>
                                    월<%=sTmpDate.substring(6, 8)%>일  <%=arrDateTitle[i] %>
                                </td>
                                <td nowrap="nowrap">
                                    <%
                                        if (listResult != null) {
