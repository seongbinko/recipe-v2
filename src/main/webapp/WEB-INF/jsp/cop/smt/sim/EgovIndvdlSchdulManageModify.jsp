...
<div id="wrap">
    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <form:form commandName="indvdlSchdulManageVO" action="/cop/smt/sim/EgovIndvdlSchdulManageModifyActor.do"
                       method="post" enctype="multipart/form-data">
                <div class="modify_user">
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
                        <tr>
                            <th width="20%" height="23" class="required_text" nowrap>일정구분
                                <!--  <img src="${ImgUrl}icon/required.gif" width="15" height="15">--></th>
                            <td width="80%">
                        ...
                        <tr>
                            <th width="20%" height="23" class="required_text" nowrap>중요도
                                <!--<img src="${ImgUrl}icon/required.gif" width="15" height="15">--></th>
                            <td width="80%">
                        ...
                        <tr>
                            <th width="20%" height="23" class="required_text" nowrap>부서
                                <!--<img src="${ImgUrl}icon/required.gif" width="15" height="15">--></th>
                            <td width="80%">
                        ...
                        <tr>
                            <th width="20%" height="23" class="required_text" nowrap>일정명
                                <!--<img src="${ImgUrl}icon/required.gif" width="15" height="15">--></th>
                            <td width="80%">
                        ...
                        <tr>
                            <th height="23" class="required_text">일정 내용
                                <!--<img src="${ImgUrl}icon/required.gif" width="15" height="15">--></th>
                            <td>
                        ...
                        <tr>
                            <th width="20%" height="23" class="required_text" nowrap>반복구분
                                <!--<img src="${ImgUrl}icon/required.gif" width="15" height="15">--></th>
                            <td width="80%">
                        ...
                        <tr>
                            <th width="20%" height="23" class="required_text" nowrap>날짜/시간
                                <!--<img src="${ImgUrl}icon/required.gif" width="15" height="15">--></th>
                            <td width="80%">
                                <form:input path="schdulBgndeYYYMMDD" size="10" readonly="true" maxlength="10"/>
                                <a href="#LINK"
                                   onClick="fn_egov_NormalCalendar(document.getElementById('indvdlSchdulManageVO'), document.getElementById('indvdlSchdulManageVO').schdulBgndeYYYMMDD,'','
                                       <c:url value='/sym/cmm/EgovselectNormalCalendar.do'/>'); return false;">
                                ...
                                <a href="#LINK"
                                   onClick="fn_egov_NormalCalendar(document.getElementById('indvdlSchdulManageVO'), document.getElementById('indvdlSchdulManageVO').schdulEnddeYYYMMDD,'','
                                       <c:url value='/sym/cmm/EgovselectNormalCalendar.do'/>'); return false;">
                                    <img src="<c:url value='/images/calendar.gif' />" align="middle" style="border:0px"
                        ...
                        <tr>
                            <th width="20%" height="23" class="required_text" nowrap>담당자
                                <!--<img src="${ImgUrl}icon/required.gif" width="15" height="15">--></th>
                            <td width="80%">
                ...
                <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            <td>
                                <a href="<c:url value='/'/>/cop/smt/sim/EgovIndvdlSchdulManageMonthList.do"
                            ...
                            <td>
                                <a href="#LINK"
                                   onclick="fn_egov_save_IndvdlSchdulManage(); return false;"><spring:message
                                        code="button.save"/></a>
                            </td>
                        </tr>
                    </table>
