    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <form name="deptSchdulManageVO" id="deptSchdulManageVO"
                  action="<c:url value='/'/>cop/smt/sim/EgovIndvdlSchdulManageDailyList.do" method="post">
                        ...
                        <fieldset>
                            ...
                            <div class="sf_start">
                                <ul id="search_first_ul">
                                    <li>
                                        <select name="schdulSe" title="검색조건" class="select" id="schdulSe"
                                    ...
                                    <li>
                                        ...
                                        <a href="<c:url value='/'/>cop/smt/sim/EgovIndvdlSchdulManageDailyList.do?year=<%=iNowYear%>&amp;month=<%=iNowMonth%>&amp;day=<%=iNowDay-1%>"
                                           onclick="fnSchduleSearch('<%=iNowYear%>','<%=iNowMonth%>','<%=iNowDay-1%>'); return false;">
                                            <img alt="이전날짜로 이동" src="<c:url value='/'/><%=sImgUrl %>btn_prev.gif"
                                                 align="middle" style="margin-right:4px;border:0px;">
                                        </a>
                                        <%}%>
                                        <%=iNowDay%>일
                                        ...
                                        <a href="<c:url value='/'/>cop/smt/sim/EgovIndvdlSchdulManageDailyList.do?year=<%=iNowYear%>&amp;month=<%=iNowMonth%>&amp;day=<%=iNowDay+1%>"
                                           onclick="fnSchduleSearch('<%=iNowYear%>','<%=iNowMonth%>','<%=iNowDay+1%>'); return false;">
                                            <img alt="다음날짜로 이동" src="<c:url value='/'/><%=sImgUrl %>btn_next.gif"
                                                 align="middle" style="margin-left:4px;border:0px;">
                                        </a>
                                        <%}%>
                                    </li>
