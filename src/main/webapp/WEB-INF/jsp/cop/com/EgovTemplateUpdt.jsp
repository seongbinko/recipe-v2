        ...
        <div id="content">
            ...
            <form:form commandName="templateInf" name="templateInf" method="post">
                ...
                <div class="modify_user">
                    <table>
                        <tr>
                            <th width="20%" height="23" class="required_text" nowrap><spring:message
                                    code="cop.tmplatNm"/></th>
                            <td width="80%" nowrap="nowrap">
                                <input name="tmplatId" type="hidden" size="60"
                                       value='<c:out value="${TemplateInfVO.tmplatId}"/>' maxlength="60">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="tmplatSeCode" name="tmplatSeCode" class="select"
                                        onchange="fn_egov_selectTmplatType(this)">
                        ...
                        <tr>
                            ...
                            <td width="80%" nowrap="nowrap">
                                <input id="tmplatCours" name="tmplatCours" type="text" size="60"
                                       value='<c:out value="${TemplateInfVO.tmplatCours}"/>' maxlength="60"
                                       style="width:100%">
                        ...
                        <tr>
                            ...
                            <td width="80%" nowrap="nowrap">
                                Y : <input type="radio" name="useAt" class="radio2" value="Y"
                            <c:if test="${TemplateInfVO.useAt == 'Y'}"> checked="checked"</c:if> >&nbsp;
                                N : <input type="radio" name="useAt" class="radio2" value="N" <c:if
                                    test="${TemplateInfVO.useAt == 'N'}"> checked="checked"</c:if>>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            <td>
                                <a href="#LINK" onclick="fn_egov_update_tmplatInfo(); return false;"><spring:message
                                        code="button.save"/></a>
                            </td>
                            <td width="10"></td>
                            <td>
                                <a href="<c:url value='/cop/com/selectTemplateInfs.do'/>"
                                   onclick="fn_egov_select_tmplatInfo(); return false;"><spring:message
                                        code="button.list"/></a>
                            </td>
                            <td width="10"></td>
                            <td>
                                <a href="#LINK" onclick="fn_egov_previewTmplat(); return false;"
                                   title="새창"><spring:message code="cop.preview"/></a>
                            </td>
                        </tr>
                    </table>
                </div>
