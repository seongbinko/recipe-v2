            ...
            <form:form commandName="templateInf" name="templateInf" method="post">
                ...
                <div class="modify_user">
                    <table>
                        ...
                        <tr>
                            ...
                            <td width="80%" nowrap="nowrap">
                                <input name="tmplatCours" type="text" size="60" value="" maxlength="60"
                                       style="width:100%" id="tmplatCours" title="템플릿경로">
                ...
                <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            <td>
                                <a href="<c:url value='/cop/com/insertTemplateInf.do'/>"
                                   onclick="fn_egov_regist_tmplatInfo(); return false;">저장</a>
                            </td>
                            <td width="10"></td>
                            <td>
