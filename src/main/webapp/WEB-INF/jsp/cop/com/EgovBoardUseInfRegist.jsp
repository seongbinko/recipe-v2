    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <form:form commandName="boardUseInf" name="boardUseInf" method="post">
                <div style="visibility:hidden;display:none;"><input name="iptSubmit" type="submit" value="전송"
                                                                    title="전송"></div>
                ...
                <div class="modify_user">
                    <table summary="게시판명, 커뮤니티 동호회 정보  입니다">
                        <tr>
                            <th width="30%" height="23" class="required_text" nowrap><spring:message
                                    code="cop.bbsNm"/><img src="<c:url value='/images/required.gif' />" width="15"
                                                           height="15" alt="required"/>
                            </th>
                            <td width="70%" nowrap colspan="3">
                                <input name="bbsId" type="hidden"/>
                                <input name="bbsNm" type="text" size="40" value="" maxlength="40" title="게시판명"
                                       readonly/>
                                &nbsp;<a href="#LINK" onclick="fn_egov_inqire_bbsInf();"
                                         style="selector-dummy: expression(this.hideFocus=false);"><img
                                    src="<c:url value='/images/img_search.gif' />"
                        ...
                        <tr>
                            ...
                            <td width="70%" nowrap colspan="3">
                                <select id="trgetType" name="trgetType" class="select" title=""
                ...
                <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            <td><a href="#LINK" onclick="fn_egov_regist_bbsUseInf(); "><spring:message
                                    code="button.create"/></a>
                            </td>
                            <td width="10"></td>
                            <td><a href="<c:url value='/cop/com/selectBBSUseInfs.do'/>?searchCondition=1"
                                   onclick="fn_egov_select_bbsUseInfs(); return false;"><spring:message
                                    code="button.list"/></a>
                            </td>
                        </tr>
                    </table>
