                            ...
                            <ul id="search_first_ul">
                                <li>
                                    <select name="searchCnd" class="select" title="검색조건 선택">
                                        ...
                                        <option value="2"
                                                <c:if test="${searchVO.searchCnd == '2'}">selected="selected"</c:if> >
                                            작성자
                                        </option>
                                    </select>
                                </li>
                                ...
                                <li>
                                    <div class="buttons" style="position:absolute;left:870px;top:182px;">
                                        <a href="#LINK" onclick="fn_egov_select_noticeList('1'); return false;"><img
                ...
                <table summary="번호, 제목, 게시시작일, 게시종료일, 작성자, 작성일, 조회수   입니다" cellpadding="0" cellspacing="0">
                    ...
                    <c:forEach var="result" items="${resultList}" varStatus="status">
                        ...
                        <tr>
                            ...
                            <td><b><c:out
                                    value="${paginationInfo.totalRecordCount+1 - ((searchVO.pageIndex-1) * searchVO.pageSize + status.count)}"/></b>
                            </td>
                            <td align="left">
