                            ...
                            <ul id="search_first_ul">
                                <li>
                                    ...
                                    <select id="searchCnd" name="searchCnd" title="검색유형선력">
                                        <option value="0"
                                                <c:if test="${searchVO.searchCnd == '0'}">selected="selected"</c:if> >
                                            게시판명
                                        </option>
                                        <option value="1"
                                                <c:if test="${searchVO.searchCnd == '1'}">selected="selected"</c:if> >
                                            게시판유형
                                        </option>
                                    </select>
                                </li>
                                <li>
                                    ...
                                    <input title="검색값입력" id="searchWrd" name="searchWrd" type="text" size="35"
                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="position:absolute;left:870px;top:182px;">
                                        ...
                                        <a href="<c:url value='/cop/bbs/addBBSMaster.do'/>"
                                        ...
                                        <input type="submit" value="<spring:message code="button.list" />"
                                               onclick="fn_egov_select_brdMstr('1'); return false;" id="invisible"
                                               class="invisible"/>
                                    </div>
                                </li>
                            </ul>
