                    ...
                    <table>
                        <tr>
                            ...
                            <td width="80%" nowrap="nowrap" colspan="3">
                                <input name="nttSj" title="<spring:message code="cop.nttSj" />" type="text" size="60"
                                       value='<c:out value="${result.nttSj}" />' maxlength="60">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <textarea id="nttCn" name="nttCn" cols="75" rows="20" style="width:99%;"
                                          title="<spring:message code="cop.nttCn" />"><c:out value="${result.nttCn}"
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <input name="ntceBgndeView" type="text" size="10" title="ntceBgndeView"
                                           ...
                                           readOnly
                                           onClick="fn_egov_NormalCalendar(document.board, document.board.ntceBgnde, document.board.ntceBgndeView,'','
                                    ...
                                    <input name="ntceEnddeView" type="text" size="10" title="ntceEnddeView"
                                           ...
                                           readOnly
                                           onClick="fn_egov_NormalCalendar(document.board, document.board.ntceEndde, document.board.ntceEnddeView,'','
                                               <c:url value='/sym/cmm/EgovselectNormalCalendar.do'/>');">
                                    <img src="<c:url value='/images/calendar.gif' />"
                                         onClick="fn_egov_NormalCalendar(document.board, document.board.ntceEndde, document.board.ntceEnddeView,'','
                                             <c:url value='/sym/cmm/EgovselectNormalCalendar.do'/>');"
                        ...
                        <tr>
                            <c:if test="${bdMstr.authFlag == 'Y'}">
                                <c:if test="${result.frstRegisterId == searchVO.frstRegisterId}">
                                    <td>
                                        <a href="#LINK" onclick="fn_egov_regist_notice(); return false;"><spring:message
                                                code="button.save"/></a>
                                    </td>
                                    <td width="10"></td>
                                </c:if>
                            ...
                            <td>
                                <a href="<c:url value='/cop/bbs${prefix}/selectBoardList.do'/>"
                                   onclick="fn_egov_select_noticeList(); return false;"><spring:message
                                        code="button.list"/></a>
                            </td>
                        </tr>
                    </table>
