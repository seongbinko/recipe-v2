        ...
        <div id="content">
            ...
            <form:form commandName="board" name="board" method="post" enctype="multipart/form-data">
                ...
                <div id="border" class="modify_user">
                    <table>
                        <tr>
                            <th width="20%" height="23" nowrap="nowrap"><label for="nttSj"><spring:message
                                    code="cop.nttSj"/></label>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <textarea id="nttCn" name="nttCn" class="textarea" cols="75" rows="20"
                            ...
                            <c:when test="${bdMstr.bbsAttrbCode == 'BBSA01'}">
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <input name="ntceBgndeView" type="text" size="10" value="" title="게시시작일"
                                               readonly="readonly"
                                        ...
                                        <input name="ntceEnddeView" type="text" size="10" value="" title="게시종료일"
                                               readonly="readonly"
                ...
                <div class="buttons" style="padding-top:10px;padding-bottom:10px;">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                            ...
                            <td>
                                <a href="#LINK" onclick="fn_egov_select_noticeList(); return fasle;"><spring:message
                                        code="button.list"/></a>
                            </td>
                        </tr>
                    </table>
