    ...
    <table cellpadding="1" class="table-line">
        ...
        <tr>
            <th class="title" width="36" colspan="1">
                <a href="#LINK"
                   onclick="fnChangeCalendar(${resultList[0].year-1},${resultList[0].month}); return false;"
                   style="selector-dummy:expression(this.hideFocus=false);cursor:pointer;cursor:hand;"><img
                        src="<c:url value='/images/btn/icon_pre_year.gif' />" alt="이전년도"></a>
            </th>
            <th class="title" width="36" colspan="1">
                <a href="#LINK"
                   onclick="fnChangeCalendar(${resultList[0].year},${resultList[0].month-1}); return false;"
                   style="selector-dummy:expression(this.hideFocus=false);cursor:pointer;cursor:hand;"><img
                        src="<c:url value='/images/btn/icon_pre_month.gif' />" alt="이전달"></a>
            </th>
            ...
            <th class="title" width="36" colspan="1">
                <a href="#LINK"
                   onclick="fnChangeCalendar(${resultList[0].year},${resultList[0].month+1}); return false;"
                   style="selector-dummy:expression(this.hideFocus=false);cursor:pointer;cursor:hand;"><img
                        src="<c:url value='/images/btn/icon_aft_month.gif' />" alt="다음달"></a>
            </th>
            <th class="title" width="36" colspan="1">
                <a href="#LINK"
                   onclick="fnChangeCalendar(${resultList[0].year+1},${resultList[0].month}); return false;"
                   style="selector-dummy:expression(this.hideFocus=false);cursor:pointer;cursor:hand;"><img
                        src="<c:url value='/images/btn/icon_aft_year.gif' />" alt="다음년도"></a>
            </th>
        </tr>
        <tr>
                    ...
                    <c:otherwise>
                        <c:choose>
                            <c:when test='${result.restAt == "Y" }'>
                                <td class="lt_text3" STYLE="color:red;cursor:pointer;cursor:hand"
                                    onClick="fnReturnDay(${result.day});">
                                        ${result.day}
                                </td>
                            </c:when>
                            <c:otherwise>
                                <td class="lt_text3" STYLE="color:black;cursor:pointer;cursor:hand"
                                    onClick="fnReturnDay(${result.day});">
                                        ${result.day}
                                </td>
                            </c:otherwise>
