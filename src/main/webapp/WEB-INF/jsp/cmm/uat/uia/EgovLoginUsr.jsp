...
<div id="wrap">
    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <!-- 타이틀 이미지 -->
            <div id="content_img_div"><img alt="LOGIN 표준프레임워크 경량환경 단순 홈페이지에 오신것을 환영합니다."
                                           src="<c:url value='/'/>images/subtitle/img_subtitle_login.gif" width="776"
                                           height="230"/></div>
            <div class="user_login">
                <form:form name="loginForm" method="post" action="#LINK">
                    <div class="user_login_ultop">
                        <ul>
                            <li>
                                <label for="id"><img alt="login"
                                                     src="<c:url value='/'/>images/login/img_idtext.gif"/></label>
                                <input type="text" class="input_style" title="아이디를 입력하세요." id="id" name="id"
                                       maxlength="10"/>
                            </li>
                            <li>
                                <label for="password"><img alt="password"
                                                           src="<c:url value='/'/>images/login/img_pwtext.gif"/></label>
                                <input type="password" class="input_style" maxlength="25" title="비밀번호를 입력하세요."
                                       id="password" name="password"
                                       onkeydown="if (event.keyCode == 13) { actionLogin(); }"/>
                            </li>
                            <li>
                                <input type="checkbox" name="checkId" onclick="saveid(this.form);" id="checkId"/><label
                                    for="checkId">ID저장</label>
                            </li>
                        </ul>
                        <input type="image" alt="로그인 버튼" class="btn_style" onclick="actionLogin()"
