...
<div id="wrap">
    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <!-- //현재위치 네비게이션 끝 -->
            <!-- 타이틀 이미지 -->
            <div id="content_img_div"><img src="<c:url value='/'/>images/subtitle/img_subtitle03-02.gif" width="776"
                                           height="230" alt="둗고/답하기 각종 문의 사항에 대한 답변을 친절하게 제공해 드리고 있습니다."/></div>
            <!-- main content 시작 -->
                ...
                <table summary="사용자목록관리" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="align_left_text"><a
                                href="<c:url value='EgovPageLink.do?link=main/sample_menu/EgovQADetail'/>">공통컴포넌트 중 모니터링
                            관련 서비스 실행시 오류가 발생합니다(15)</a></td>
                        <td>홍길동</td>
                        <td>1232</td>
                        <td>2011-04-04</td>
                    </tr>
                    <tr>
                        ...
                        <td class="align_left_text"><a
                                href="<c:url value='EgovPageLink.do?link=main/sample_menu/EgovQADetail'/>">validation 처리
                            시.패스워드에 대한 메소드를 찾지 못합니다.</a></td>
                        <td>홍길동</td>
                        <td>111</td>
                        <td>2011-04-04</td>
                    </tr>
