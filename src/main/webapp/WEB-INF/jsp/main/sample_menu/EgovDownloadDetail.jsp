    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <div id="content_img_div"><img src="<c:url value='/'/>images/subtitle/img_subtitle03-01.gif" width="776"
                                           height="230" alt="자료실 전자정부표준프레임워크 경량환경 페이지의 다양한 종류의 자룔르 다운 받으실 수 있습니다."/>
            </div>

            <div id="download_div02">
                <div class="downloadDetail_title">
                    <div class="downloadDetail_program_loc"><span class="downloadDetail_titletxt">egovframe installer v1.03</span>
                    </div>
                ...
                <div class="sum_img_div_wrap">
                    ...
                    <div class="download_btn_area"><a href="#"><img src="<c:url value='/'/>images/btn/btn_download.gif"
                                                                    alt="download"/></a></div>
                </div>
            ...
            <div class="buttons" style="clear:both;float:right;padding-top:10px;padding-bottom:10px;"><a
                    href="javascript:fn_main_headPageMove('31','main/sample_menu/EgovDownload')">목록 </a></div>
