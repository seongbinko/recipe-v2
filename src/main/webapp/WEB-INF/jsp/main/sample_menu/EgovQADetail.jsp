    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <div id="content_img_div"><img src="<c:url value='/'/>images/subtitle/img_subtitle03-02.gif" width="776"
                                           height="230" alt="묻고/답하기 각종 문의 사항에 대한 답변을 친절하게 제공해 드리고 있습니다."/>
            </div>
            <!-- main content 시작 -->
            ...
            <div class="qa_1st_wrap">
                <div class="qa_1st_loc">
                    ...
                    <p>javax.servlet.ServletException: Could not get RequestDispatcher for
            ...
            <div class="qa_answer">
                <div>
                    <ul>
                        ...
                        <li>
                            <div class="qa_btn_delete">삭제하기</div>
                        </li>
                    </ul>
                </div>
            </div>
