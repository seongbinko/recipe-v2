    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <div id="content_img_div"><img src="<c:url value='/'/>images/subtitle/img_subtitle01.gif" width="776"
                                           height="230"
                                           alt="홈페이지 소개 표준프레임워크 경량환경의 개요와 연력, 조직소개, 표준프레임워크센터의 약도 등의 정보를 제공하고 있습니다."/>
            </div>
            <!-- main content 시작 -->
            <div class="content_field">
                <div><h2>찾아오시는길</h2></div>
                <h3>무교청사 찾아 오시는 길 </h3>
                <p><img src="<c:url value='/'/>images/img_content/img_egovframelocation.gif" width="656" height="402"
                        alt="무교청사 약도"/></p>
                <div>
                    <h3>상세안내 </h3>
                    <fieldset>
