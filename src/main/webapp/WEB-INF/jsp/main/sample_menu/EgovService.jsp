...
<div id="wrap">
    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <!-- //현재위치 네비게이션 끝 -->
            <!-- 타이틀 이미지 -->
            <div id="content_img_div"><img src="<c:url value='/'/>images/subtitle/img_subtitle03-03.gif" width="776"
                                           height="230" alt="서비스 신청 표준프레임워크 경량환경의 원하시는 서비스를 신청을 하실 수 있습니다."/></div>
