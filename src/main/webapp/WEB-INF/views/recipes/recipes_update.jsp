...
<head>
    ...
    <script defer src="/js/recipe_update.js"></script>
</head>
<body>
<header>
...
<section>
    <div class="container">
        ...
        <form id="recipe-registerform" class="form-horizontal well" method="post" enctype="multipart/form-data"
              action="" onsubmit="return checkUpdate()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <label class="btn btn-default btn-file">
                                파일변경<input id="file_1" class="form-control" type="file" accept=".jpg, .png, .PNG, .JPG"
                                           name="img" max="" placeholder="" style="display: none">
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div id="last" class="preview-img">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <label class="btn btn-default btn-file">
                            파일변경<input class="form-control" type="file" name="img" accept='.jpg, .png, .PNG, .JPG'
                                       style="display: none"/>
            ...
            <div class="form-group">
                <div class="col-sm-offset-4 col-sm-4">
                    <button id="btn-update" type="submit" class="btn btn-primary btn-lg" value="">수정</button>
