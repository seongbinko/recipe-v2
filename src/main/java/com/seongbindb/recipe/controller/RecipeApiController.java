...
public class RecipeApiController {
    ...
    public ModelAndView save(RecipeRegisterform recipeRegisterform, HttpSession session, MultipartHttpServletRequest request, ModelAndView mav) throws Exception {
    ...
    public Map<String, Object> searchUpdatePage(@PathVariable int recipeNo, HttpSession session) throws Exception {
